...
activities = [
    ...
    },
    {
        "name": "東京スカイツリー® 日時指定券",
        "price": 1800,
        "description": "日本一の高さを誇る東京スカイツリーに登って、東京の上空から富士山までの絶好の眺めを楽しみましょう！日付指定チケットで事前予約をすれば、当日列に並ぶ必要はありません！昼間に家族で訪れて大都会を一望するもよし、夜のロマンチックな景色をカップルで楽しむのもよし。クリスマスや年末年始はイベントも盛りだくさん！素晴らしいパノラマと特別ライトアップをご堪能ください。n★スカイツリーと チームラボプラネッツ のセットプランはこちら。スカイツリーと 都内地下鉄24時間パス のセットプランはこちら。n※本プランは、催行日によって料金が異なるため、予約ステップ②で選択する催行日によって、料金表示が変わります。",
    ...
    },
    {
        ...
        "price": 4200,
        "description": "n東京お台場にある国内最大級の屋内型テーマパーク「東京ジョイポリス」のパスポートチケットです。完全屋内施設なので、天気に関係なくいつでも遊べます。絶叫系、ホラー系、館内探検型など、バラエティ豊かなアトラクションが20種類以上あるので、1日中楽しめます。チケットを事前購入して、思いっきり満喫しましょう！nnn 楽天トラベル 観光体験では「パスポート」の現地販売価格（大人（18歳以上）5,000円／小･中･高生4,000円）より、大人（18歳以上）：800円OFFの4,200円、小・中・高生：400円OFFの3,600円でご購入いただけます！nnn※2023年5月19日（金）は終日貸切営業のため、前売券利用不可日となります。",
    ...
    },
    {
        "name": "サンシャイン水族館",
        "price": 2600,
        "description": "東京・池袋のサンシャインシティ内にあるサンシャイン水族館は、日本初の都市型高層水族館です。「天空のオアシス」をコンセプトに、水や緑に満ちた非日常空間で、多種多様な生き物に出会えます。nnn屋内エリアでは、海や川、湖などで様々な生き物が暮らす水のある風景が広がり、屋外エリアでは、頭上に広がるドーナツ型水槽「サンシャインアクアリング」をお楽しみいただけます。頭上の水槽の中をアシカが飛ぶように泳ぐ様子は必見です！nその他、幅約12mの解放感のある水槽で泳ぐ「天空のペンギン」、どの方向からも楽しむことができるアシカパフォーマンス、日本最大級の横幅となるミズクラゲの展示水槽ではふわふわと浮遊するクラゲを観察できます。nnnサンシャイン水族館オリジナル商品を販売しているショップや限定メニューを揃えたカフェも併設しています。nnn※本プランは、催行日によって料金が異なるため、予約ステップ②で選択する催行日によって、料金表示が変わります。n※本チケットの予約・決済が完了されたお客様は、水族館の日時指定WEB整理券の取得は必要ありませんので、予約した日付に直接水族館入口までお越しいただき、バウチャーのQRコードをご提示ください。nn",
    ...
    },
    {
        ...
        "price": 3850,
        "description": "南青山のヨックモックミュージアムではアートセラピーを応用したアートセッションを開催しています。芸術の心理的、精神的な効用に着目した参加型プログラムで、毎月異なるユニークな催しを企画しています。n小さなお子さまから大人の方まで参加できるクラスをご用意しております。nオンラインチケットは楽天トラベル 観光体験でのみ販売を行っていますので、ぜひ事前にご予約ください。",
    ...
    },
    {
        ...
        "price": 5300,
        "description": "※本プランは、催行日によって料金が異なるため、予約ステップ②で選択する催行日によって、料金表示が変わります。nnn★スカイツリー優先入場Eチケットはこちら。n★スカイツリーと都内地下鉄24時間パスのセットプランはこちら。",
    ...
    },
    {
        ...
        "price": 4400,
        "description": "RED° TOKYO TOWERは東京タワー内にある、リアル×バーチャルが楽しめる次世代型テーマパークです。n身体を動かして楽しむゲームから、ポーカーなどのマインドスポーツまでさまざまなアトラクションが充実。nグルメやキッズエリアもあり、年齢問わず楽しめます。n最先端のXR技術を搭載したスタジアムでイベントや大会も楽しめます！nnn★RED°KIDS Eチケットはこちら。RED°E-SAUNA（サウナ）はこちら。n★東京タワーメインデッキのチケットはこちら。nnn※チケット購入前注意事項※nnn12歳未満の方は保護者の同伴が必須です。n18時以降は16歳未満の方は保護者の同伴がないと入場ができません。n1階はパーク入場チケット対象外施設です。n全館貸切の場合は一般の方はご利用いただけません。カレンダーで選択可能な場合もある為、ご購入前に公式サイトの開館スケジュールを必ずご確認ください。n本施設では価格変動制を導入しており、施設窓口での販売価格は日によって異なります。詳細は公式サイトをご確認ください。",
    ...
    },
    {
        ...
        "price": 1200,
        "description": "概要n東京タワーの展望台（メインデッキ）の入場チケットを事前予約！東京都内のパノラマビューを最大限に楽しみましょう。nnn★東京タワーメインデッキとTokyo Subway Ticketのセットはこちら。n★RED° TOKYO TOWERのチケットはこちら。n★RED°KIDSのチケットはこちらnnnハイライトn東京タワーメインデッキ（150m）の入場券を事前予約！n東京タワーから眺めるパノラマビューをお楽しみください。n恋愛にまつわるパワースポットもお見逃しなく！n★楽天アカウントでのご予約で、楽天ポイントが貯まる＆使える！",
    ...
    },
    {
        ...
        "price": 600,
        "description": "n「鳩山会館」は、内閣総理大臣を務めた鳩山一郎の邸宅を記念館として一般に公開したものです。イギリス風の外観でアダムスタイルの応接間などがある西洋館となっています。東京都内からであれば簡単にアクセスできますので、一度訪れてみませんか？nnnハイライトn東京メトロ有楽町線「江戸川橋駅」から徒歩約7分、「護国寺駅」から徒歩約8分です。n庭園には80種類ものバラが咲き誇り、洋館と合わせて素晴らしい景観を楽しめます",
    ...
    },
    {
        ...
        "price": 3050,
        "description": "東京スカイツリー®入場チケットと都内の地下鉄乗車券（24時間乗り放題）がセットになったプランです。24時間乗り放題乗車券は東京メトロと都営地下鉄のすべての路線で使用できます。東京スカイツリー®チケットは「天望デッキ」と「天望デッキ＋天望回路」からお好きなプランをお選びいただけます。nnn★スカイツリー優先入場Eチケットはこちら。スカイツリーとチームラボプラネッツのセットプランはこちら。nnn※本プランは、催行日によって料金が異なるため、予約ステップ②で選択する催行日によって、料金表示が変わります。",
    ...
    },
    {
        ...
        "price": 2250,
        "description": "レゴランド・ディスカバリー・センター東京では、エキサイティングな乗り物を楽しんだり、大好きなキャラクターに会ったり、無限に広がるレゴ®ブロックで学んだり遊んだり、創造力を自由に発揮して楽しめます。事前にEチケット（引換券）を入手するとスムーズに入場できます。nnnハイライトnEチケット（引換券）：印刷不要、スマホのチケット提示でOKn優先的に入場できるEチケット（引換券）で、行列に並ぶ必要はありません。n事前予約で1日券が売り切れる前に購入できます。",
    ...
    },
    {
        ...
        "price": 1100,
        "description": "n南青山にある美術館「ヨックモックミュージアム」でピカソの創造性を体感しませんか？世界有数のピカソのセラミックコレクションの展示やアートセラピーを取り入れたイベント、「菓子とアート」の独自プログラムもご用意しております。n前売り券と通常券のオンライン購入は、楽天トラベル 観光体験でのみ販売しています。チケットはご指定の催行日から1ヶ月以内ならいつでもご利用可能です。もちろん当日予約も可能です！nnnハイライトnオンラインチケットは当日受付で購入される券よりも100円お得です！当日予約も可能！nヨックモックグループが30年以上かけて収集してきたピカソのセラミックコレクションをご覧いただけます。n楽天アカウントでのご予約で、楽天ポイントが貯まる＆使える！nチケットはご指定の催行日から1ヶ月以内ならいつでもご利用可能です",
    ...
    },
    {
        ...
        "image": "https://experiences.travel.rakuten.co.jp/experiences/25993",
        "region": "都心",
    ...
    },
    {
        ...
        "image": "https://experiences.travel.rakuten.co.jp/experiences/21191",
        "region": "都心",
    ...
    },
    {
        ...
        "image": "https://experiences.travel.rakuten.co.jp/experiences/23624",
        "region": "東部",
    ...
    },
    {
        ...
        "image": "https://experiences.travel.rakuten.co.jp/experiences/26140",
        "region": "東部",
    ...
    },
    {
        ...
        "image": "https://experiences.travel.rakuten.co.jp/experiences/25512",
        "region": "都心",
    ...
    },
    {
        ...
        "image": "https://experiences.travel.rakuten.co.jp/experiences/31258",
        "region": "都心",
    ...
    },
    {
        ...
        "image": "https://experiences.travel.rakuten.co.jp/experiences/25686",
        "region": "東部",
    ...
    },
    {
        ...
        "image": "https://experiences.travel.rakuten.co.jp/experiences/22578",
        "region": "都心",
